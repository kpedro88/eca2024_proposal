...
\textbf{This composite, strongly coupled DM can only be accessed at colliders.}
...
model-independent searches using unsupervised AI and fast, accurate simulation via generative AI are of interest
not only in collider physics, but also in neutrino physics, astrophysics, and more.
...
With the early career funding, the PI will assemble a team with the necessary skills to carry out this program.
...
Fermilab provides a unique AI associate (AIA) program, which hires post-baccalaureate researchers who specialize in AI and computing.
...
The PI's position and connections at Fermilab, therefore, are multipliers for the DOE's early career investment.
