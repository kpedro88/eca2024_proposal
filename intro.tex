...
The program proposed here leverages DOE facilities, including Fermilab and HPCs, to advance multiple elements of the HEP mission:
...
In addition, Fermilab is home to numerous experts on CMS detector subsystems, especially the calorimeters that dominate simulation time.
